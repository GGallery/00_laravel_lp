...
<body>
    ...
    <main class="pt-12 bg-gray-100">
        ...
        <div class="bg-gray-300 text-center py-12 mt-14">
            ...
            <h3 class="h3-line">Visita il mio sito: <a href="https://www.sarapadovano.com/" class="text-red-800">www.sarapadovano.com</h3>
        </div>
        
    </main>


    <footer class="text-white py-6 flex justify-center items-center">
