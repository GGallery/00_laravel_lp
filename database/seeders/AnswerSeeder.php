...
class AnswerSeeder extends Seeder
{
    ...
    public function run(): void {
        $answers = [
            1 => ['a) Risposta A', 'b) Risposta B', 'c) Risposta C'],
            2 => ['a) Risposta A', 'b) Risposta B', 'c) Risposta C'],
            3 => ['a) Risposta A', 'b) Risposta B', 'c) Risposta C'],
            4 => ['a) Risposta A', 'b) Risposta B', 'c) Risposta C'],
